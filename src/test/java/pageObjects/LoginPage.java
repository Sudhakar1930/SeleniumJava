...
public class LoginPage extends BasePage {
	...
	@FindBy(xpath="//input[@name='form_type']/following-sibling::p")
	WebElement lblSignupErrMsg;
	...
	public boolean isEmailErrorExist() {
		boolean bisDisplayed;
		try {
			bisDisplayed = lblSignupErrMsg.isDisplayed();
	...
	public String getSignUpErrMsg() {
		String sSignupErrMsg = lblSignupErrMsg.getText();
		return sSignupErrMsg;
	}
